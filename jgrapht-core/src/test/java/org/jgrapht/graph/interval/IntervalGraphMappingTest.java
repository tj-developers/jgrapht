...
public class IntervalGraphMappingTest {
    ...
    private IntervalGraphMapping<IntervalVertexPair<Integer, Integer>, DefaultEdge, Integer, Integer> intervalGraphMapping;
    ...
    public void testAddVertex() {
        ...
        IntervalVertexPair<Integer, Integer> vertex1 = IntervalVertexPair.of(1, interval1);
        intervalGraphMapping.addVertex(vertex1);

        Interval<Integer> interval2 = new Interval<>(4, 309);
        IntervalVertexPair<Integer, Integer> vertex2 = IntervalVertexPair.of(2, interval2);
    ...
    public void testRemoveVertex() {
        ...
        ArrayList<IntervalVertexPair<Integer, Integer>> vertices = new ArrayList<>();
    ...
    public void testIsMappingValidAfterRemovingOrAddingVertices() {
        ...
        IntervalVertexPair<Integer, Integer> vertex3 = IntervalVertexPair.of(2, interval3);

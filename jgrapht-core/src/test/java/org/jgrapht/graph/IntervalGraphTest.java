...
public class IntervalGraphTest {
    ...
    @Before
    public void setUp() {
        intervalGraph = new IntervalGraph(SupplierUtil.createIntegerSupplier(), SupplierUtil.createDefaultEdgeSupplier(), false);

        weightedIntervalGraph = new IntervalGraph(SupplierUtil.createIntegerSupplier(), SupplierUtil.createDefaultWeightedEdgeSupplier(), true);
    }
    ...
    public void cloneIntervalGraph() {
        ...
        assertEquals(clonedIntervalGraph.getEdgeSupplier(), intervalGraph.getEdgeSupplier());
    ...
    public void initialiseWithVertices() {
        ...
        IntervalGraph<IntervalVertexInterface<Integer, Integer>, DefaultEdge, Integer, Integer> graph =
                new IntervalGraph(vertices, SupplierUtil.createDefaultEdgeSupplier(), false);

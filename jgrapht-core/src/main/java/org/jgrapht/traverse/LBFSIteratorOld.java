 ...
 * @since March 2018
 */
public class LBFSIteratorOld<V, E>
        extends
        AbstractGraphIterator<V, E>
{
     ...
     */
    public LBFSIteratorOld(Graph<V, E> graph)
    {
        super(graph);
    ...
    class BucketList
    {
        ...
        private class Bucket
        {
            ...
            Bucket split(Collection<V> splitVertices)
            {
                LinkedHashSet<V> newVertices = split(vertices, splitVertices);
                return new Bucket(newVertices);

            }
            private LinkedHashSet<V> split(Set<V> vertices, Collection<V> splitVertices)
            {

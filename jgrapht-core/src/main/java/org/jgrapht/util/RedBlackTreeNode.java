...
/**
 * Implementation of RedBlackTreeNode
...
public class RedBlackTreeNode<K, V> implements Serializable {
     ...
     */
    private RedBlackTreeNode<K, V> leftChild, rightChild;
    /**
     ...
     */
    public RedBlackTreeNode(K key, V val, boolean red, int size) {
        this.key = key;
        this.val = val;
        this.red = red;
        this.size = size;
     ...
     */
    protected void setLeftChild(RedBlackTreeNode<K, V> leftChild) {
     ...
     */
    protected void setRightChild(RedBlackTreeNode<K, V> rightChild) {

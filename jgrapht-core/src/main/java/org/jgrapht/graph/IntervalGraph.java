...
/**
 * Implementation of an interval graph. An interval graph is an intersection graph of intervals on a line. Because of
...
public class IntervalGraph<V extends IntervalVertexInterface<VertexType, T>, E, VertexType, T extends Comparable<T>> extends AbstractGraph<V, E> implements Graph<V, E>, Cloneable, Serializable {
    ...
    private void addExistingIntervalEdges(V sourceVertex, V targetVertex, E edge) {
     ...
     */
    private void removeAllEdgesFromVertex(V vertex) {

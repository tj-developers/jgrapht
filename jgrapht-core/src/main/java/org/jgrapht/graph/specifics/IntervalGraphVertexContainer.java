...
/**
 * The container used in the implementation of interval graphs. It is used to efficiently access queries to the intervals.
 *
 ...
 * @since Apr 26, 2018
 */
class IntervalGraphVertexContainer<V extends IntervalVertexInterface<VertexType, T>, E, VertexType, T extends Comparable<T>>
        implements IntervalGraphVertexContainerInterface<V, E>, Serializable {
